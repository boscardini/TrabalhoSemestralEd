...
public class ProfessorForm extends JDialog {
	...
	private void onSalvar() {
		try {
			Professor p = new Professor(Integer.parseInt(txtId.getText()), txtCpf.getText(), txtNome.getText(),
					Float.parseFloat(txtPontos.getText()), txtIdArea.getText());
	...
	private void onConsultar() {
		try {
			...
			for (int i = 0; i < lista.size(); i++) {
				...
				sb.append(String.format("%d - %s (%s) - Pontos: %.2f%n",
